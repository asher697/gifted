...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~mr4GnDpS#9tHRJiMfmIhz6l7KYEoE6HuwrwR36pisSTsirqOdHiE", // Add sess Id here especially when deploying on panels else use app.json and .env file...
